...
// rot and scale
const rotUniformLocation = gl.getUniformLocation(program, 'angle') // Getting data from our vertex shader
const scaleUniformLocation = gl.getUniformLocation(program, 'scaling') // Getting data from our vertex shader
...
function draw() {
  ...
  gl.uniform1f(rotUniformLocation, (counter % 400) / 100)
  gl.uniform2f(scaleUniformLocation, counter % 200, counter % 200)
